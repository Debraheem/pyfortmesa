...
That default mode is intentionally no-MESA. It runs import/unit checks, syntax
checks for the MESA shell runners, a dry no-MESA summary-suite path, and a
...
When a behavior change intentionally changes the no-MESA test output, inspect
